...
module.exports = {
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || '+923302918898', // Mettez votre numéro ici
    BOT_NAME: " 𝐌𝐎𝐄𝐄𝐃𝐱𝐓𝐄𝐂𝐇",
    BOT_FOOTER: '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴍᴏᴇᴇᴅ-ᴍᴅ',
    ...
    GROUP_INVITE_LINK: process.env.GROUP_INVITE_LINK || 'https://chat.whatsapp.com/FrNo0anW2pNIIIk5L8kv0W?s=cl&p=a&ilr=0',
    ...
    // 7. IMAGES & LIENS
    // ===========================================================
    IMAGE_PATH: 'https://files.catbox.moe/dj2npg.png',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbD5c47FHWq7h2oYnm3l',
    
    // ===========================================================
    // 8. EXTERNAL API (Optionnel)
    // ===========================================================
    TELEGRAM_BOT_TOKEN: process.env.TELEGRAM_BOT_TOKEN || '8722347987:AAFcjznMdN8dlPez9OQRtmQsLtsU0xd_ofE',
    TELEGRAM_CHAT_ID: process.env.  TELEGRAM_CHAT_ID || '8299012795'
