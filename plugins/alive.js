...
const ALIVE_IMG = "https://files.catbox.moe/dj2npg.png"; // Make sure this URL is valid
...
> 🤖 *Status*: *Moeed-MD-Mini is Alive and Ready!*
        ...
        await conn.sendMessage(from, {
            ...
            contextInfo: { 
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: '120363426281901729@newsletter',
                    newsletterName: 'ᴍᴏᴇᴇᴅ-ᴍᴅ',
                    serverMessageId: 143
                }
            }
        }, { quoted: fakevCard });
